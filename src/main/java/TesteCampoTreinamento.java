...
//				.getText().contains("Campo de Treinamento"));
	...
	/*
	 * só deve ser utilizado em casos onde o selenium não dê conta de realizar os
	 * testes é possivel alterar elementos da pagina usando o javascript
	 */
	...
	public void testJavascript() {
		...
		js.executeScript("document.getElementById('elementosForm:nome').value = 'david'");
	...
	public void clicarBotaoTabela() {
		dsl.clicarBotaoTabela("Nome", "Maria", "Botao", "elementosForm:tabelaUsuario");
	}
